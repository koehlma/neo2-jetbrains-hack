...
public class KeyEvent extends InputEvent {
    ...
    // begin: neo2 hack
    // NEO2 Keymap
    static final int[] neoKeyMap = new int[128];
    static {
        neoKeyMap[VK_I] = VK_LEFT;
        neoKeyMap[VK_E] = VK_RIGHT;
        neoKeyMap[VK_L] = VK_UP;
        neoKeyMap[VK_A] = VK_DOWN;
        neoKeyMap[VK_U] = VK_HOME;
        neoKeyMap[VK_O] = VK_END;
        neoKeyMap[VK_Z] = VK_UNDO;
        neoKeyMap[VK_W] = VK_PAGE_DOWN;
        neoKeyMap[VK_X] = VK_PAGE_UP;
        neoKeyMap[VK_SPACE] = VK_NUMPAD0;
        neoKeyMap[VK_M] = VK_NUMPAD1;
        neoKeyMap[VK_COMMA] = VK_NUMPAD2;
        neoKeyMap[VK_PERIOD] = VK_NUMPAD3;
        neoKeyMap[VK_N] = VK_NUMPAD4;
        neoKeyMap[VK_R] = VK_NUMPAD5;
        neoKeyMap[VK_T] = VK_NUMPAD6;
        neoKeyMap[VK_H] = VK_NUMPAD7;
        neoKeyMap[VK_G] = VK_NUMPAD8;
        neoKeyMap[VK_F] = VK_NUMPAD9;
    }
    // end: neo2 hack
    ...
    public KeyEvent(Component source, int id, long when, int modifiers,
        ...
        // begin: neo2 hack
        //System.out.println("modifiers: " + modifiers + " keyCode: " + keyCode + " keyChar: " + keyChar + " keyLocation: " + keyLocation);
        final int neoKeyCode = keyCode < neoKeyMap.length && keyCode >= 0 ? neoKeyMap[keyCode] : 0;
        if (((keyChar == 0xffff && keyLocation == 1) || keyLocation == 4) && neoKeyCode != 0) {
            this.keyCode = neoKeyCode;
            //System.out.println("neoKeyCode: " + neoKeyCode);
        } else if (keyChar == VK_TAB && keyLocation == 1 && (keyCode == '8' || keyCode == 0)){
            this.keyCode = VK_TAB;
        } else if (keyChar == VK_ESCAPE && keyLocation == 1 && keyCode == 0) {
